...
<!-- run this code below in your browser's console! :

// or you can just go to the extended version: https://www.genekogan.com/works/a-book-from-the-sky2.html

var zloops = [["and","和"],["before","前"],["Beijing","京"],["buy","买"],["By","者"],["can","可"],["Capital","资"],["car","车"],["city","市"],["class","班"],["Close","合"],["color","色"],["Correct","对"],["country","国"],["Culture","文"],["Current","现"],["Eye","目"],["Family","户"],["Female","女"],["for","为"],["four","四"],["Green","生"],["hair","发"],["hand","手"],["he","他"],["heart","心"],["I","我"],["in","中"],["industry","业"],["Item","件"],["king","王"],["Live","过"],["machine","机"],["male","男"],["Many","多"],["meeting","会"],["Minute","分"],["month","月"],["Months","个"],["need","需"],["negative","负"],["new","新"],["of","的"],["Office","任"],["old","老"],["on","上"],["one","一"],["open","开"],["Out","出"],["people","人"],["period","期"],["positive","正"],["Rear","后"],["Reason","理"],["recognize","认"],["Remember","记"],["Safe","地"],["Say","说"],["Scholar","士"],["Sell","售"],["shadow","影"],["she was","她"],["small","小"],["square","方"],["station","台"],["still","仍"],["surface","面"],["Ten thousand","万"],["The","所"],["Theory","论"],["They","们"],["This","今"],["three","三"],["to make","成"],["two","二"],["under","下"],["want","要"],["water","水"],["week","周"],["What","何"],["when","当"],["will","将"],["With","以"],["world","世"],["year","年"],["you","你"]];
var interpolations = [["beijing_capital",[["Beijing","京"],["capital","资"]]],["beijing_city_capital_country_world", [["Beijing","京"],["city","市"],["capital","资"],["country","国"],["world","世"]]],["city_country",[["city","市"],["country","国"]]],["comego",[["come","来"],["go","走"]]],["culture_family",[["culture","文"],["family","户"]]],["largesmall",[["large","大"],["small","小"]]],["malefemale",[["male","男"],["female","女"]]],["n1234",[["one","一"],["two","二"],["three","三"],["four","四"]]],["oldnew",[["old","老"],["new","新"]]],["people1_family",[["people","人"],["family","户"]]],["people2_culture_family",[["people","民"],["culture","文"],["family","户"]]],["positive_negative",[["positive","正"],["negative","负"]]],["she_he_i",[["she","她"],["he","他"],["I","我"]]],["they_you_i",[["they","们"],["you","你"],["I","我"]]],["timecurrent",[["time","时"],["current","现"]]],["wantneed",[["want","要"],["need","需"]]],["you_i",[["you","你"],["I","我"]]]];
var html = '<br/>';
zloops.forEach(function(z) { 
html += '<div class="zloop"><img src="/images/a-book-from-the-sky/zloops/i_z_'+z[0]+'.gif" ><br/>'+z[1]+'<span class="en">&nbsp;'+z[0]+'</span></div>';
});	
$(".zloops.bottom").append(html);
html = '<br/>';
interpolations.forEach(function(z) { 
components = ''
z[1].forEach(function(w) {
	components += '<br/>'+w[1]+'<span class="en">&nbsp;'+w[0]+'</span>';
});
html += '<div class="interpolation"><img src="/images/a-book-from-the-sky/interpolations/i_'+z[0]+'.gif" />'+components+'</div>';
});
$(".interpolations.bottom").append(html);
-->
